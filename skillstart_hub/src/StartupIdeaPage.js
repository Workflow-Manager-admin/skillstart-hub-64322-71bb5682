...
import './StartupIdeaPage.css'; // Import the custom CSS for background/overlay
...
function StartupIdeaPage() {
  ...
  return (
    <div>
      <div className="startup-bg-wrapper" />
      <div className="startup-bg-overlay" />

      <div className="startup-content-area">
        <div className="startup-card-section" style={{ marginTop: "72px" }}>
          {/* SKILL INPUT */}
          <h2 style={{
            color: "#4A90E2",
            fontWeight: 700,
        ...
        <div className="startup-card-section" style={{ background: "rgba(242,255,250,0.95)" }}>
